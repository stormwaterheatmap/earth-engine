...
var rasters = {
  'Hydrology Data Layers': {
    ...
    'Runoff (inches)': {
      layer: {
        eeObject: data.mean_annual_runoff.divide(ee.Image(25.4))
          .rename('mean_annual_runoff_inches'),
        name: 'Mean Annual Runoff',
        visParams: {
          palette: [
            "#291b32",
  ...
  'Input Data Layers': {
    ...
    'Age of Development': {
      layer: {
        eeObject: data.age_of_development.rename(
          'age_of_development'), //var visParams = {
